    ...
    <section class=" h-100 hero">
        <div class="container row align-items-center mx-auto flex-wrap-reverse">
            <div class="col-md-6 col-12 position-relative">
                <h1 class="fw-bold text-secondary big-brand">SIKAMDIS</h1>
                <h1 class="fw-bold text-primary title-brand">SIKAMDIS</h1>
                <p class="text-secondary">SIKAMDIS adalah aplikasi untuk mengelola rekam medis pasien secara digital,
                    memudahkan pencatatan,
                    penyimpanan, dan
                    akses informasi kesehatan guna meningkatkan efisiensi layanan medis.</p>
                <div class="text-secondary d-flex gap-2 align-items-center"><span class="line bg-secondary"></span>
                    <span>Jl. Abdul
                        Wahid
                        No.
                        20, Jember</span>
    ...
    <section class="about-app">
        <div class="container">
            ...
            <div class="row gy-5 align-items-center">
                ...
                <div class="col-md-6 col-12">
                    <h6 class="fw-bold mb-0 text-secondary ">TENTANG</h6>
                    <h3 class="text-primary fw-bold">SIKAMDIS</h3>
                    <p class="text-secondary">SIKAMDIS aplikasi adalah sistem berbasis digital yang digunakan untuk
    ...
    <section class="feature-app">
        <div class="container">
            <div class="row gy-5 flex-wrap-reverse align-items-center">
                <div class="col-md-6 col-12">
                    <h6 class="fw-bold mb-0 text-secondary ">FITUR</h6>
                    <h3 class=" fw-bold">FITUR UNGGULAN <span class="text-primary">
                            SIKAMDIS
                        </span></h3>
                    <p class="text-secondary">SIKAMDIS memiliki beberapa fitur unggulan antara lain:</p>
                    <ul class="list-unstyled d-flex flex-column gap-3">
                        <li class="d-flex gap-3 text-secondary"><i class="fa-solid text-primary fa-hospital-user"></i>
                            <span>Akses
                                Data Pasien yang
                                Mudah dan
                                Cepat</span>
                        </li>
                        <li class="d-flex gap-3 text-secondary"><i class="fa-solid text-primary fa-list"></i>
                            <span>Manajemen Riwayat
                                Kesehatan
                                Pasien</span>
                        </li>
                        <li class="d-flex gap-3 text-secondary"><i class="fa-solid text-primary fa-lock"></i>
                            <span>Keamanan dan
                                Privasi Data</span>
                        </li>
                    </ul>
                ...
                <div class="col-md-3 col-sm-4 col-12">
                    <div class="card border-0 ">
                        <div class="card-body p-5 text-center">
                            ...
                            <p class="text-secondary text-center">Akses Informasi yang Cepat dan Akurat</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-4 col-12">
                    <div class="card border-0 ">
                        <div class="card-body p-5 text-center">
                            ...
                            <p class="text-secondary text-center">Pengelolaan Riwayat Kesehatan yang Terpusat</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-4 col-12">
                    <div class="card border-0 ">
                        <div class="card-body p-5 text-center">
                            ...
                            <p class="text-secondary text-center">Meningkatkan Keamanan dan Privasi Data</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-4 col-12">
                    <div class="card border-0 ">
                        <div class="card-body p-5 text-center">
                            ...
                            <p class="text-secondary text-center">Mengurangi Kesalahan Medis</p>
                        </div>
                    </div>
                </div>
            </div>
